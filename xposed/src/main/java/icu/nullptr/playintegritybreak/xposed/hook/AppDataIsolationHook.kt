...
import icu.nullptr.playintegritybreak.xposed.XposedConstants.STORAGE_MANAGER_SERVICE_CLASS
...
class AppDataIsolationHook(private val service: PIBService): IFrameworkHook {
