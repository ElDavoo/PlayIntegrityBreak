...
import icu.nullptr.playintegritybreak.common.Utils
import icu.nullptr.playintegritybreak.xposed.PIBService
import icu.nullptr.playintegritybreak.xposed.Utils4Xposed
import icu.nullptr.playintegritybreak.xposed.XposedConstants.ACTIVITY_STACK_SUPERVISOR_CLASS
import icu.nullptr.playintegritybreak.xposed.XposedConstants.ACTIVITY_STARTER_CLASS
import icu.nullptr.playintegritybreak.xposed.XposedConstants.ACTIVITY_TASK_SUPERVISOR_CLASS
import icu.nullptr.playintegritybreak.xposed.XposedConstants.COMPUTER_ENGINE_CLASS
import icu.nullptr.playintegritybreak.xposed.XposedConstants.PACKAGE_MANAGER_SERVICE_CLASS
import icu.nullptr.playintegritybreak.xposed.logD
import icu.nullptr.playintegritybreak.xposed.logE
import icu.nullptr.playintegritybreak.xposed.logI
import icu.nullptr.playintegritybreak.xposed.logV

class ActivityHook(private val service: PIBService) : IFrameworkHook {
    companion object {
