...
import icu.nullptr.playintegritybreak.common.AppPresets
import icu.nullptr.playintegritybreak.common.Constants
import icu.nullptr.playintegritybreak.common.FilterHolder
import icu.nullptr.playintegritybreak.common.IPIBService
import icu.nullptr.playintegritybreak.common.JsonConfig
import icu.nullptr.playintegritybreak.common.PresetCacheHolder
import icu.nullptr.playintegritybreak.common.RiskyPackageUtils.appHasGMSConnection
import icu.nullptr.playintegritybreak.common.SettingsPresets
import icu.nullptr.playintegritybreak.common.Utils.binderLocalScope
import icu.nullptr.playintegritybreak.common.Utils.generateRandomString
import icu.nullptr.playintegritybreak.common.Utils.getInstalledApplicationsCompat
import icu.nullptr.playintegritybreak.common.Utils.getInstalledPackagesCompat
import icu.nullptr.playintegritybreak.common.Utils.getPackageInfoCompat
import icu.nullptr.playintegritybreak.common.Utils.getPackageUidCompat
import icu.nullptr.playintegritybreak.common.app_presets.DetectorAppsPreset
import icu.nullptr.playintegritybreak.common.settings_presets.ReplacementItem
import icu.nullptr.playintegritybreak.xposed.hook.AccessibilityHook
import icu.nullptr.playintegritybreak.xposed.hook.ActivityHook
import icu.nullptr.playintegritybreak.xposed.hook.AppDataIsolationHook
import icu.nullptr.playintegritybreak.xposed.hook.ContentProviderHook
import icu.nullptr.playintegritybreak.xposed.hook.IFrameworkHook
import icu.nullptr.playintegritybreak.xposed.hook.ImmHook
import icu.nullptr.playintegritybreak.xposed.hook.PlatformCompatHook
import icu.nullptr.playintegritybreak.xposed.hook.PmsHookTarget29
import icu.nullptr.playintegritybreak.xposed.hook.PmsHookTarget30
import icu.nullptr.playintegritybreak.xposed.hook.PmsHookTarget31
import icu.nullptr.playintegritybreak.xposed.hook.PmsHookTarget33
import icu.nullptr.playintegritybreak.xposed.hook.PmsHookTarget34
import icu.nullptr.playintegritybreak.xposed.hook.PmsPackageEventsHook
import icu.nullptr.playintegritybreak.xposed.hook.ZygoteHook
...
class PIBService(val pms: IPackageManager, val pmn: Any?) : IPIBService.Stub() {

    companion object {
        private const val TAG = "PIB-Service"
        var instance: PIBService? = null
    }
    ...
    init {
        ...
        loadPresetCache()
        installHooks()
        logI(TAG, "PIB service initialized")
