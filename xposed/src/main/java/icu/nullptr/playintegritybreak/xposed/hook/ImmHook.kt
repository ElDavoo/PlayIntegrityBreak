...
import icu.nullptr.playintegritybreak.common.settings_presets.InputMethodPreset
import icu.nullptr.playintegritybreak.xposed.PIBService
import icu.nullptr.playintegritybreak.xposed.Utils4Xposed
import icu.nullptr.playintegritybreak.xposed.XposedConstants.IMM_SERVICE_CLASS
...
class ImmHook(private val service: PIBService) : IFrameworkHook {
    companion object {
