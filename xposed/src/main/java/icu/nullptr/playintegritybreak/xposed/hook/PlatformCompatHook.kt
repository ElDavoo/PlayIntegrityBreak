...
import icu.nullptr.playintegritybreak.xposed.XposedConstants.PLATFORM_COMPAT_CLASS
...
class PlatformCompatHook(private val service: PIBService) : IFrameworkHook {
