...
import icu.nullptr.playintegritybreak.xposed.XposedConstants.CONTENT_PROVIDER_TRANSPORT_CLASS
import icu.nullptr.playintegritybreak.xposed.logD

class ContentProviderHook(private val service: PIBService): IFrameworkHook {
    companion object {
